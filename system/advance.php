...
<form method="POST" action="advanceE.php?est=<?php echo"$code";?>&end=<?php echo $_GET['end']?>">
...
if (isset($_GET['end'])){
$month = $_GET['end'];
$sql = "SELECT * FROM Total WHERE DATE(DemandDate) > '$month' AND ReceivedDate <= '$month' ORDER BY ReceivedDate, Unit, ManageFeeDate";
