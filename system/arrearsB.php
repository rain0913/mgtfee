...
<form method="POST" action="arrearsBE.php?est=<?php echo"$code";?>&end=<?php echo $_GET['end']; ?>">
...
if (isset($_GET['end'])){
$month = $_GET['end'];
$sql = "SELECT * FROM Total WHERE DATE(DemandDate) <= '$month' AND (BankInDate >= '$month' OR BankInDate IS NULL ) ORDER BY Unit, ManageFeeDate";
