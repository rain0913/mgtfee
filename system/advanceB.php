...
<form id="search-form" onsubmit="return performSearch()">
 ...
 <form method="POST" action="advanceBE.php?est=<?php echo"$code";?>&end=<?php echo $_GET['end']?>">
...
if (isset($_GET['end'])){
$month = $_GET['end'];
$sql = "SELECT * FROM Total WHERE DATE(DemandDate) > '$month' AND BankInDate <= '$month' ORDER BY BankInDate, ReceivedDate, Unit, ManageFeeDate";
